                        ...
                        <div class="p-l-10 p-t-20 p-b-20" style="background-color: honeydew">
                            ...
                            <div class="row">
                                    ...
                                    <div class="form-group p-t-10 col-md-4">
                                            ...
                                            <input type="number" class="form-control" name="sale" value="{{$groupProduct->Sale}}" min="0" max="100" aria-describedby="helpId" placeholder="sale">
                                    </div>
                            </div>
                            <div class="row m-t-30 m-l-5">
                                <div class="form-group">
                                    ...
                                    <input type="file" onchange="readURL(this)" class="form-control-file" style="display: none" name="avatar" accept="image/jpg, image/jpeg, image/png" aria-describedby="fileHelpId">
                                </div>
                                <img class="m-l-30" style="height: 300px" src="{{route('home')}}/image/{{$groupProduct->productByColor()->get()->first()->SmallImage}}" id="img-avatar">
                            </div>
                            <div class="form-group">
