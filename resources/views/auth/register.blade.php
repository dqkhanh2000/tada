...
@section('content')
<div class="page-wrapper" style="padding-bottom: 30%">
                    ...
                    <div class="login-form">
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="form-group">
                              ...
                              <input id="address" type="text" class="form-control @error('address') is-invalid @enderror" name="address" value="{{ old('address') }}" required autocomplete="address-line1" autofocus>
                            ...
                            <div class="form-group">
                              ...
                              <select class="form-control @error('address') is-invalid @enderror" value="{{ old('gender') }}" name="gender" id="gender">
                                    <option>Men</option>
                                    <option>Women</option>
                                </select>
...
{{-- <div class="container p-t-150 p-b-100">
